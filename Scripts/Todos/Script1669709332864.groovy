...
response = WS.sendRequest(findTestObject('Todos/GET_Todos'))
...
//post
response = WS.sendRequest(findTestObject('Todos/POST_todos'))
...
//delete
response = WS.sendRequest(findTestObject('Todos/DELETE'))
