...
response = WS.sendRequest(findTestObject('Photos/GET_Photos'))
...
//post
response = WS.sendRequest(findTestObject('Photos/POST_photos'))
...
//delete
response = WS.sendRequest(findTestObject('Photos/DELETE_photos'))
