...
response = WS.sendRequest(findTestObject('Userss/users'))
...
//post
response = WS.sendRequest(findTestObject('Userss/Post_users'))
...
//delete
response = WS.sendRequest(findTestObject('Userss/DELETE_Users'))
